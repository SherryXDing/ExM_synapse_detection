from exm_deeplearn_lib.exmsyn_models import vgg_like_v2
...
batch_sz = 16
n_gpus = 4
# save_name = save_path + 'model_vgg2/vgg2'
generator = gen_vgg_batch(pos_img_names, neg_img_names, batch_sz=batch_sz*n_gpus)
history = network.train_network(generator=generator, steps_per_epoch=100, epochs=2000, n_gpus=n_gpus, save_name=None, validation_data=None)

with open(save_path+'model_vgg2/history_lr1e-3_sgd_batch64_steps100_epochs2000_L1err_vgg2.pkl', 'wb') as f:
    pickle.dump(history.history, f)

network.save_whole_network(save_path+'model_vgg2/vgg2')
network.save_architecture(save_path+'model_vgg2/vgg2')