from exm_deeplearn_lib.exmsyn_models import vgg_like
...
history = network.train_network(generator=generator, steps_per_epoch=100, epochs=500, n_gpus=n_gpus, save_name=save_path+'model/vgg', validation_data=(test_img, test_label))

with open(save_path+'history_batch64_steps100_epochs500_train_vali.pkl', 'wb') as f:
