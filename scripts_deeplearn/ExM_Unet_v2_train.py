...
img_mask_junk_names = [(file_path+'antennal_lobe_1/5793_2782_11411.nrrd', file_path+'antennal_lobe_1/mask_unet_syn1_edge2.nrrd', file_path+'antennal_lobe_1/mask_junk.nrrd'), \
    (file_path+'ellipsoid_body_1/C1-7527_3917_6681.nrrd',file_path+'ellipsoid_body_1/mask_unet_syn1_edge2.nrrd', file_path+'ellipsoid_body_1/mask_junk.nrrd'), \
    (file_path+'mushroom_body_1/C1-6210_6934_5492.nrrd', file_path+'mushroom_body_1/mask_unet_syn1_edge2.nrrd', file_path+'mushroom_body_1/mask_junk.nrrd'), \
    (file_path+'optic_lobe_1/C1-4228_3823_4701.nrrd', file_path+'optic_lobe_1/mask_unet_syn1_edge2.nrrd', file_path+'optic_lobe_1/mask_junk.nrrd'), \
    (file_path+'protocerebrum_1/C1-13904_10064_4442.nrrd', file_path+'protocerebrum_1/mask_unet_syn1_edge2.nrrd', file_path+'protocerebrum_1/mask_junk.nrrd')]
...
with open(save_path+'history_rawdata_gen2_batch64_steps100_epochs500.pkl', 'wb') as f:
