...
def remove_small_piece(out_hdf5_file, img_file_name, location, mask=None, threshold=10, percentage=0.7):
    """
    ...
    percentage: threshold to remove the object if it falls in the mask less than a percentage (default=0.7)
    """
